  ...
  return (
    <div className="min-h-screen bg-black flex justify-center items-center py-10 max-w-7xl mx-auto px-4">
      ...
      >
        ...
        <h2 className="text-white text-2xl mb-6">Datos Personales</h2>
        ...
        <h2 className="text-white text-2xl mt-10 mb-6">Información de Pago</h2>
        ...
        <div className="mt-10 p-5 rounded bg-zinc-800 border border-blue-700">
          <h3 className="text-white text-xl mb-2">Importe: ${importe}</h3>

          <p className="text-gray-300">
            Plan:
            <span className="text-white font-bold ml-2">{plan}</span>
          </p>
        </div>
        ...
        <Button
          ...
          onClick={() => {
            toast.promise(
              new Promise((resolve) =>
                setTimeout(() => resolve({ name: "Listo: " }), 1000),
              ),
              {
                loading: "Loading...",
                success: (data) => `${data.name} Ya estás suscripto.`,
                error: "Error",
                position: "top-center",
              },
            );
